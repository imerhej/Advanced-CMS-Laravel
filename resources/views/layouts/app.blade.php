          ...
          <div class="container">
            <div class="nav-left">
              <a class="nav-item" href="{{route('home')}}">
                <img src="{{asset('images/logo.png')}}" alt="Advanced CMS" />
              </a>
            ...
            <div class="nav-right" style="overflow: visible;">
              ...
              @else
                <button class="dropdown is-aligned-right nav-item is-tab">
                  Hey Issam <span class="icon"><i class="fa fa-caret-down"></i></span>
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="#">
                      <span class="icon"><i class="fa fa-fw m-r-10 fa-sign-out"></i></span> Logout</a></li>
                  </ul>
                </button>
              @endif
            </div>
